...
console.log(canWeDeliver(93625))
...
console.log(canWeDeliverTwo(93625))
...
// I am not sure what it means by removing white space, but I will certainly do that if I see the lives site and then understand.
